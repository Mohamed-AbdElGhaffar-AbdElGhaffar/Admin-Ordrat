...
const COLORS = ['#e11d48', '#e34c5c', '#e66f76', '#e98090'];
...
const localizedData = {
  en: [
    { name: 'plan 1', value: 58 },
    { name: 'plan 2', value: 45 },
    { name: 'plan 3', value: 32 },
    { name: 'plan 4', value: 16 },
  ],
  ar: [
    { name: 'خطة 1', value: 58 },
    { name: 'خطة 2', value: 45 },
      ...
      <div className="h-full items-center gap-4 @sm:flex">
        ...
        <div className="@sm:w-2/5 @sm:ps-2">
          <div className="mb-4 mt-1">
            <div className="mb-1.5 text-gray-700">{t('profits')}</div>
          ...
          <div className="">
            ...
            {chartData.map((item: { value: number; name: string; }, index:any) => (
              <Detail key={index} color={COLORS[index]} value={item.value} text={item.name} />
            ))}
          </div>
        </div>
      </div>
