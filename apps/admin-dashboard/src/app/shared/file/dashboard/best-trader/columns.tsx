...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="table-text-email"/>,
    dataIndex: "email",
    key: "email",
    width: 110,
  ...
  {
    title: <HeaderCell title="table-text-phoneNumber"/>,
  ...
  {
    title: <HeaderCell title="table-text-isActive"/>,
    dataIndex: "status",
    key: "status",
    width: 110,
    render: (value: any) => <span className="text-gray-500">{value}</span>,
  ...
  {
    title: <HeaderCell title="table-text-totalSales"/>,
  ...
  // {
  //   title: <HeaderCell title="table-text-subdomain" />,
  //   dataIndex: "subdomain",
  //   key: "subdomain",
  //   width: 100,
  //   render: (value: any) => (
  ...
  // },
  // {
  //   title: <HeaderCell title="table-text-qr" className="ps-2" />,
  //   dataIndex: "QR",
  //   key: "QR",
  //   width: 40,
  //   render: (value: any) => (
