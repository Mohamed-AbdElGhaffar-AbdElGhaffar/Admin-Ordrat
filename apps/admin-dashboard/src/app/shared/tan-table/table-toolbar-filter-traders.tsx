...
export default function TableToolbarFilterTraders<TData extends Record<string, any>>({
  table,
  lang = "en",
  nameEN="Sellers",
  nameAr="التجار",
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-wrap items-center gap-4">
        ...
        />
        {!isMediumScreen && showFilters && <FilterElements lang={lang} table={table} inputName={inputName} setInputName={setInputName} inputPhoneNumber={inputPhoneNumber} setInputPhoneNumber={setInputPhoneNumber} selectedValue={selectedValue} setSelectedValue={setSelectedValue} toFromDate={toFromDate} setToFromDate={setToFromDate} />}
      </div>
        ...
        {isMediumScreen && (
          <FilterDrawerView isOpen={openDrawer} setOpenDrawer={setOpenDrawer}>
            <div className="grid grid-cols-1 gap-6">
              <FilterElements lang={lang} table={table} inputName={inputName} setInputName={setInputName} inputPhoneNumber={inputPhoneNumber} setInputPhoneNumber={setInputPhoneNumber} selectedValue={selectedValue} setSelectedValue={setSelectedValue} toFromDate={toFromDate} setToFromDate={setToFromDate} />
            </div>
          </FilterDrawerView>
        )}
