...
import styles from '../../faq/AddFaqForm/FAQForm.module.css';
...
type AddArticalFormProps = {
  title?: string;
  onSuccess?: () => void;
  lang: string;
};

export default function AddArticalForm({
  title,
  onSuccess,
  lang = 'en',
}: AddArticalFormProps) {
  ...
  const mainFormik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        toast.success(
          lang === 'ar' ? 'تم انشاء المقالة بنجاح!' : 'Artical created successfully!'
        );
        ...
        toast.error(
          lang === 'ar'
            ...
            : 'Failed to create Artical. Please try again.'
        );
      }
    },
  });
